...
#ifndef __ARCH_LAMBDASOC_INCLUDE_TLS_H
#define __ARCH_LAMBDASOC_INCLUDE_TLS_H
...
static inline FAR struct tls_info_s *up_tls_info(void)
{
  ...
  return TLS_INFO((uintptr_t)lambdasoc_getsp());
}
#else
#  define up_tls_info() tls_get_info()
#endif

#endif /* __ARCH_LAMBDASOC_INCLUDE_TLS_H */
